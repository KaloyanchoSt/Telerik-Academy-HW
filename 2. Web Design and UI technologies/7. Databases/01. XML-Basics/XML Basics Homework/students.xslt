...
<xsl:stylesheet
      version="1.0"
      xmlns:students="urn:http://telerikacademy.com/Forum/Home:students"
        ...
        <table border="1px solid black;">
          ...
          <xsl:for-each select="/students/students:student">
            <tr>
              ...
              <td>
                <xsl:value-of select="students:taken-exams/exam/name"></xsl:value-of>
              </td>
              <td>
                <xsl:value-of select="students:taken-exams/exam/tutor"></xsl:value-of>
              </td>
              <td>
                <xsl:value-of select="students:taken-exams/exam/score"></xsl:value-of>
              </td>
            </tr>
          </xsl:for-each>
        </table>
